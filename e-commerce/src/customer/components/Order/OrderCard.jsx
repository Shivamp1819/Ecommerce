        ...
        <Grid item xs={6}>
          ...
          <div className='flex cursor-pointer'>
            ...
            <div className='ml-5 space-y-2'>
              ...
              <p className='opacity-50 text-xs font-semibold space'>Size: M</p>
              <p className='opacity-50 text-xs font-semibold space'>Color: Black</p>
